...
9. Output
    ...
    - figs/random_forest_results.csv - auc values over different sample sizes
    - figs/figure4.pdf - mean AUC over different sample sizes
    - figs/rf_feature_importances.csv - extracted Gini feature importances
    - figs/shap_class_0.pdf - shap summary for feature importance for class b-other
    - figs/shap_class_1.pdf - shap summary for feature importance for class b1
